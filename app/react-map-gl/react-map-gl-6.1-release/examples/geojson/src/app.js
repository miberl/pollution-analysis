...
export default function App() {
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      'https://raw.githubusercontent.com/miberl/Analisi-PM10/main/app/react-map-gl/react-map-gl-6.1-release/examples/geojson/geojson.geojson?token=ALGT6QJKZ7ALS7S345RPUPLASATNC'
    )
      .then(resp => resp.json())
